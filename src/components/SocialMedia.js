    ...
    return (
        <Container className='pt-5'>
            <Row className='d-flex justify-content-center'>
                <Col sm={12} md={5} className="d-flex flex-column justify-content-center align-items-center mb-5 " style={{ height: '250px', backgroundColor: '#FF5F29', borderRadius: 5, padding: '40px'}}>
                ...
                <Col sm={12} md={5} className='d-flex flex-column justify-content-center align-items-center mb-5 offset-md-1' style={{height: '250px', backgroundColor: '#FF5F29', borderRadius: 5, padding: '40px'}}>
