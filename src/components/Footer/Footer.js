                    ...
                    <Col className="footer-box"> 
                        <div className="d-flex justify-content-md-center">
                            <a href="https://www.facebook.com/BeduOrg" target="_blank" rel="noreferrer">
                                <svg className="mr-3 mx-md-2 social-networks-icon" viewBox="0 0 39 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="https://www.linkedin.com/school/beduorg/mycompany/" target="_blank" rel="noreferrer">
                                <svg className="mr-3 mx-md-2 social-networks-icon bi bi-linkedin" fill="#fff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
